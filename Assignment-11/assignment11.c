...
int main(void) {
  ...
  // initialize a variable to increase and iterate through our array to store
  // scores
  int numScores;
  ...
  // start a loop that will start at 0, and then it'll iterate through our
  // scores array until it reaches the end each element in the array will be
  // added to the sum so that we can find the average
